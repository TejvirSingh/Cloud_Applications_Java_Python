## A simple social site using basic python. With a web interface that will allow to upload pictures and will let other users to post 
# comments on the pics. There can be 4-5 users predefined. 
