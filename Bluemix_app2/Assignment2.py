...
#Cloud Computing
# File and Folder handling using Bluemix and python. : The idea behind this project is to be able to create folders/containers on Bluemix 
# machine and to be able to upload files after encrypting using AES encryption and download that file after decrypting using AES decryption. 
